...
var HeatmapLayer = function (_MapLayer) {
  ...
  HeatmapLayer.prototype.updateHeatmapProps = function updateHeatmapProps(nextProps) {
    var shouldUpdateRadius = nextProps.radius && (!this.props || nextProps.radius !== this.props.radius);
    var shouldUpdateBlur = nextProps.blur && (!this.props || nextProps.blur !== this.props.blur);
